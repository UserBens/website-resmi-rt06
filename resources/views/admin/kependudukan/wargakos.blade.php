...
@section('konten')
    <p class="card-title">Data Warga Kos</p>
    ...
    <form action="{{ route('wargakos.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="d-flex flex-wrap justify-content-xl-between">
            <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                ...
                <div class="d-flex flex-column justify-content-around">
                    <small class="mb-1 text-muted">Total Penduduk Kos</small>
                    <input type="text" class="form-control form-control-sm" name="jml_penduduk" id="jml_penduduk"
                        value="{{ old('jml_penduduk', $wargakos->jml_penduduk ?? '') }}">
                </div>
            </div>
            ...
            <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                ...
                <div class="d-flex flex-column justify-content-around">
                    ...
                    <input type="text" class="form-control form-control-sm" name="jml_laki" id="jml_laki"
                        value="{{ old('jml_laki', $wargakos->jml_laki ?? '') }}">
                </div>
            </div>
            ...
            <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                ...
                <div class="d-flex flex-column justify-content-around">
                    ...
                    <input type="text" class="form-control form-control-sm" name="jml_perempuan" id="jml_perempuan"
                        value="{{ old('jml_perempuan', $wargakos->jml_perempuan ?? '') }}">
                </div>
            </div>
            ...
            <div class="d-flex border-md-right flex-grow-1 align-items-center justify-content-center p-3 item">
                ...
                <div class="d-flex flex-column justify-content-around">
                    ...
                    <input type="text" class="form-control form-control-sm" name="jml_kk" id="jml_kk"
                        value="{{ old('jml_kk', $wargakos->jml_kk ?? '') }}">
                </div>
            </div>
        </div>
