                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__links">
                            <a href="/">Home</a>
                            <a href="/post"><span>Postingan</span></a>
                            <span>Detail Postingan</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-10">
                    <div class="blog__details__content">
                        <div class="blog__details__title">
                            ...
                            <h2 class="text-justify">{{ $post->judul }}</h2>
                            <img src="{{ asset('storage/' . $post->image) }}" alt="">
                            <p style="text-align: justify;" class="mb-3">{!! $post->body !!} </p>
                        </div>

                        <button class="goback-button"
                            onclick="window.location.href='{{ route('post') }}'">Kembali ke Postingan</button>
                    </div>
                </div>
            </div>
        </div>
